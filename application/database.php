...
return [
    ...
    'database'        => Env::get('database.database', 'caishen2024168'), // 数据库名
    'username'        => Env::get('database.username', 'caishen2024168'), // 用户名
    'password'        => Env::get('database.password', 'caishen2024168'), // 密码
	'prefix'          => Env::get('database.prefix', ''), // 数据库表前缀
